...
#define LOG_TAG "android.hardware.power-service.motorola-libperfmgr"
...
int main() {
    ...
    LOG(INFO) << "Motorola Power HAL AIDL Service with Extension is starting with config: "
              << config_path;
    ...
    LOG(INFO) << "Motorola Power HAL AIDL Service with Extension is started.";
